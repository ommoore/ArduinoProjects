/***********************************************
* @file  I2CSecondary_txString.ino
* @brief Arduino Mega2560 acting as I2C secondary 
*        device to receive and transfer a string, 
*        or collection of bytes, from primary. 
...
* @version 1.0
***********************************************/
//Wire (I2C) Secondary transmitter and receiver
...
void requestEvent() {
  ...
  //Wire.write("hello ");   //respond with message of 6 bytes as expected by primary
}
